...
# -*- coding: utf-8 -*-
"""
使用case4.json标准格式测试医疗诊断Agent系统

这个脚本读取case4.json文件，将其转换为系统所需的格式，
...
def test_case4():
    ...
    try:
        ...
        # 读取case4数据
        with open('medical_records/case4.json', 'r', encoding='utf-8') as f:
            case_data = json.load(f)
        
        print('\n' + '='*80)
        print('🏥 开始测试 case4.json')
        print('='*80)
        ...
        try:
            ...
            report_filename = f"output/case4_diagnosis_report_{timestamp}.json"
